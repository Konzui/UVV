...
class BBox:
    ...
    def scale(self, scale_vector):
        """Scale bounding box by vector."""
        center = self.center
        self.xmin = center.x + (self.xmin - center.x) * scale_vector.x
        self.xmax = center.x + (self.xmax - center.x) * scale_vector.x
        self.ymin = center.y + (self.ymin - center.y) * scale_vector.y
        self.ymax = center.y + (self.ymax - center.y) * scale_vector.y
